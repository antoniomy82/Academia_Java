...
<html>
    <head>
        <title>Listado de Clases para solicitar tutoría</title>
    ...
    <body>
        <h1>Clases matriculado de <s:property value="#session.nombre"/> <s:property value="#session.apellidos"/>  </h1>
        <br>
            ...
            <table id="asignaturas_t" class="display" cellspacing="0" width="100%">
                ...
                <s:iterator value="asignaturas">
                    <tr>                 
                        ...
                        <td><s:property value="nif_alumno"/><s:text name="#session.usernif"/></td>
        ...
        <br>
       <s:form action="tutocrear">
        <td><s:textfield name="id_asignatura" label="ID Clase"  placeholder="Intruduzca ID" size="15" required="required" /></td>
        <td><s:submit value="Crear Tutoría"/></td> 
        </s:form>
    <br>
    <br>
    <a href="menu_Alumn.jsp"> <img alt="" src="img/icono_devolver.png" width="80" height="80"/></a>
</body>
</html>
